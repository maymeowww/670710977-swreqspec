...
# Supports FR-BKG-04 and CON-TECH-01 slot persistence.
class Slot(Base):
    __tablename__ = "slots"
...
# Supports FR-BKG-04 and IF-HIS-01 booking persistence without national_id.
class Booking(Base):
...
# Supports DOM-PDPA-01 audit records with actor, time, and HN.
class AuditLog(Base):
