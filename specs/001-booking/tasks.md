...
| TASK-BKG-04 | ทำหน้าจอเลือกแพ็กเกจและช่วงเวลาให้โหลดข้อมูลใหม่ตามแพ็กเกจที่เลือก และแสดงที่นั่งคงเหลือ | ไม่มี | `frontend/src/pages/SlotPicker.jsx`, `frontend/src/__tests__/TASK-BKG-04.test.jsx` | เปลี่ยนแพ็กเกจแล้วหน้าจอโหลดช่วงเวลาใหม่และแสดงที่นั่งคงเหลือ และ test ผ่าน | FR-BKG-01, FR-BKG-06 | Todo |
